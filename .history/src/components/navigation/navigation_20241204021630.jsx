...
function Navigation() {
  return (
    ...
    >
      ...
      <div style={{maxWidth:"25px", display:"flex", flexDirection:"column", alignItems:"start", justifyContent:"space-between"}}>
        <div style={{height:"1px",maxWidth:"12.5px", backgroundColor:"#ffffff"}}></div>
        <div style={{height:"1px",maxWidth:"25px", backgroundColor:"#ffffff"}}></div>
        <div style={{height:"1px",maxWidth:"12.5px", backgroundColor:"#ffffff"}}></div>
      </div>
    </div>
  );
