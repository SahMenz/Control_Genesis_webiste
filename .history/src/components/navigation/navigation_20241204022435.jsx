...
function Navigation() {
  return (
    ...
    >
      ...
      <div style={{width:"32px",height:"20px", display:"flex", flexDirection:"column",}}>
        <div style={{height:"5px",width:"16px", backgroundColor:"#ffffff"}}></div>
        <div style={{margin:"10px 0px",height:"50px",width:"32px", backgroundColor:"#ffffff"}}></div>
        <div style={{height:"50px",width:"16px" ,alignSelf:"end", backgroundColor:"#ffffff"}}></div>
      </div>
    </div>
  );
}
