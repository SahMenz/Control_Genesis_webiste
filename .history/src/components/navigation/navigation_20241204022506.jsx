  ...
  return (
    ...
    >
      ...
      <div style={{width:"32px",height:"20px", display:"flex", flexDirection:"column",}}>
        <div style={{height:"7px",width:"16px", backgroundColor:"#ffffff"}}></div>
        <div style={{margin:"10px 0px",height:"7px",width:"32px", backgroundColor:"#ffffff"}}></div>
        <div style={{height:"7px",width:"16px" ,alignSelf:"end", backgroundColor:"#ffffff"}}></div>
      </div>
    </div>
  );
}
