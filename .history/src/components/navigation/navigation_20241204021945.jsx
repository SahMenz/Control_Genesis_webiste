...
function Navigation() {
  return (
    ...
    >
      ...
      <div style={{maxWidth:"25px", display:"flex", flexDirection:"column",}}>
        <div style={{height:"1px",width:"12.5px", backgroundColor:"#ffffff"}}></div>
        <div style={{margin:"10px 0px",height:"1px",width:"25px", backgroundColor:"#ffffff"}}></div>
        <div style={{height:"1px",width:"12.5px" ,alignSelf:"end", backgroundColor:"#ffffff"}}></div>
      </div>
    </div>
  );
}
