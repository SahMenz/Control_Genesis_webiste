...
function Navigation() {
  return (
    ...
    >
      ...
      <div style={{maxWidth:"28px", display:"flex", flexDirection:"column",}}>
        <div style={{height:"1.5px",width:"14px", backgroundColor:"#ffffff"}}></div>
        <div style={{margin:"10px 0px",height:"1.5px",width:"28px", backgroundColor:"#ffffff"}}></div>
        <div style={{height:"1.5px",width:"14px" ,alignSelf:"end", backgroundColor:"#ffffff"}}></div>
      </div>
    </div>
  );
}
