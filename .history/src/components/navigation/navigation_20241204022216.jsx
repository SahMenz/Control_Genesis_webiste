...
function Navigation() {
  return (
    ...
    >
      ...
      <div style={{maxWidth:"32px", display:"flex", flexDirection:"column",}}>
        <div style={{height:"2px",width:"16px", backgroundColor:"#ffffff"}}></div>
        <div style={{margin:"10px 0px",height:"1.5px",width:"32px", backgroundColor:"#ffffff"}}></div>
        <div style={{height:"2px",width:"16px" ,alignSelf:"end", backgroundColor:"#ffffff"}}></div>
      </div>
    </div>
  );
}
