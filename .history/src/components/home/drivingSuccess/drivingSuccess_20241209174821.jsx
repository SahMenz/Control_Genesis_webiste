      ...
      <div>
        ...
        <div className="d-flex flex-wrap gap-3 justify-content-between">
          ...
          <div>
            ...
            <div className="fw-400 txt-ff my-4">
              {/* <CustomSvg name="personalized" /> */}
              <div className="ms-2">
                <h2 className="fs-19 mb-2">Creative strategy</h2>
                <p className="fs-13">
                Developing unique strategies that drive growth and foster innovation.                </p>
              </div>
            </div>
            <div className="fw-400 txt-ff">
              {/* <CustomSvg name="personalized" /> */}
              <div className="ms-2">
                ...
                <p className="fs-13">
                Bringing expertise and tailored strategies for impactful results.                </p>
              </div>
            </div>
          </div>
        </div>
