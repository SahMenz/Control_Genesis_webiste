  ...
  return (
    <div style={{ marginTop: "87px", color: "#ffffff" }}>
      ...
      <div style={{ marginTop: "67px" }}>
        ...
        <div className="mt-5 d-flex align-items-center justify-content-center justify-content-xl-between gap-4 flex-wrap">
          <div
            style={{
              padding: "33px",
              borderRadius: "22px",
          ...
          >
            <img src={careerDevPlatform} />
            <div className="mt-3 mb-5 fs-11 d-flex gap-3 align-items-center justify-content-start">
              <div  style={{border:"1px solid #FAFAFF", padding:"11px 13px", borderRadius:"18px", fontWeight:"400"}}>UI/UX Design</div>
              <div  style={{border:"1px solid #FAFAFF", padding:"11px 13px", borderRadius:"18px", fontWeight:"400"}}>React.JS Development</div>
              <div  style={{border:"1px solid #FAFAFF", padding:"11px 13px", borderRadius:"18px", fontWeight:"400"}}>Website Design</div>
            </div>
            <div className="d-flex align-items-center justify-content-between">
              <div className="fw-600 fs-25">Career Dev Platform - <br /> Website Development</div>
              <div>
          ...
          >
            <img src={eduTechMobile} />
            <div className="mt-3 mb-5 fs-11 d-flex gap-3 align-items-center justify-content-start">
              <div  style={{border:"1px solid #FAFAFF", padding:"11px 13px", borderRadius:"18px", fontWeight:"400"}}>UI/UX Design</div>
              <div  style={{border:"1px solid #FAFAFF", padding:"11px 13px", borderRadius:"18px", fontWeight:"400"}}>React Native Development</div>
              <div  style={{border:"1px solid #FAFAFF", padding:"11px 13px", borderRadius:"18px", fontWeight:"400"}}>Wireframe</div>
            </div>
            <div className="d-flex align-items-center justify-content-between">
              <div className="fw-600 fs-25">Edu-Tech - Mobile <br />App Development</div>
              <div>
                <CustomSvg name="expandArrow" width="40px" />
              </div>
            </div>
