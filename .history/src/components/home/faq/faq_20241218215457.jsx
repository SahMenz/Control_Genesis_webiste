...
function Faq() {
  return (
    <div className="mt-5 txt-ff">
        ...
        <div>
            <div>
                <div className="d-flex align-items-center justify-content-between bg-22 collapseMargin" style={{padding:"30px", borderRadius:"10px"}}>
                    <div className="collapseMargin">What services do you offer?</div>
