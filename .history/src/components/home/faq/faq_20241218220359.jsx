...
function Faq() {
  return (
    <div className="mt-5 txt-ff">
        ...
        <div>
            <div className="collapseMargin bg-22 " style={{cursor:"pointer",padding:"30px", borderRadius:"10px"}}>
                <div className="d-flex align-items-center justify-content-between">
                    <div className="fs-23 fw-400">What services do you offer?</div>
                    <div><CustomSvg name="minus"/></div>
                </div>
                <div>We specialize in design, development, and strategic solutions to help businesses grow and succeed. Our services include web development, mobile app development, 
