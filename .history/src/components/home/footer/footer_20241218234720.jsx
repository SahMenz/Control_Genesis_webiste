        ...
        <div className="d-flex justify-content-between align-items-center mt-4 gap-5 flex-wrap">
            ...
            <div>
                ...
                <div className="d-flex align-items-center">
                    <input placeholder="Email address" style={{padding:"15px 20px", backgroundColor:"transparent", border:"1px solid #FFD800", borderRadius:"50px", minWidth:"120px",maxWidth:"418px", width:"30vw", marginRight:"20px",color:"#FFD800"}}/>
                    <div>
                        <CustomSvg name="send" />
                    </div>
                </div>
