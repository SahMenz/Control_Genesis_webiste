      ...
      <div className='mt-5'>
        ...
        >
          <div className="fw-500">
            ...
            <div className="fs-16">
            Project Manager - BrightFuture Labs
            </div>
          </div>
          <div style={{height:"100px"}}></div>
          <div className="fw-500 fs-13">
          Their commitment to excellence and attention to detail helped us achieve our goals faster and more efficiently. Control Genesis provided us with a seamless process, from ideation to execution.
          </div>
        </div>
        ...
        >
          <div className="fw-500">
            ...
            <div className="fs-16">
            Head of Product - HabitHack            </div>
          </div>
          <div style={{height:"100px"}}></div>
          <div className="fw-500 fs-13">
          Their professional approach and deep industry knowledge made a real difference in our success. We were able to tackle complex challenges with their strategic guidance and expertise.          </div>
        </div>
      </div>
    </div>
  );
