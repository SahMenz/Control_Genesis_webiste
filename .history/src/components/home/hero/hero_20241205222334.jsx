...
function Hero() {
  return (
    ...
    <div
      className="mt-5 d-flex flex-column flex-lg-row justify-content-between"
      id="fish"
    >
      ...
      <div className="txt-ff">
        ...
        <h2 className='fw-600 fs-23'>DEVELOP</h2>
          ...
          <p className='fs-16 fw-400'>Building robust, scalable systems that drive real-world results.</p>
        </div>
      </div>
    </div>
  );
