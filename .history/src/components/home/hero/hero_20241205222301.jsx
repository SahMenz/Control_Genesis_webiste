...
function Hero() {
  return (
    ...
    <div className="mt-5 d-flex flex-column flex-lg-row justify-content-between" id='fish'>
      ...
      <div className="txt-ff">
        <div id="deduce">
          ...
          <p className='fs-16 fw-400'>Uncover insights through data-driven analysis and strategic thinking.</p>
        </div>
        <div id="design">
        <h2 className='fw-600 fs-23'>DESIGN</h2>
          ...
          <p className='fs-16 fw-400'>Crafting innovative, user-centric solutions that inspire and engage.</p>
        </div>
        <div id="develop"></div>
      </div>
    </div>
