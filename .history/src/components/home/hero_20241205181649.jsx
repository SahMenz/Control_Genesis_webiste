  ...
  return (
    <div className="mt-5">
      <div className="txt-ff fw-500" style={{ maxWidth: "534px" }}>
        ...
        <div>
          <button className="paddingButton" style={{backgroundColor:"#FFD800", borderRadius:"29.5px",color:"black", marginRight:"30px",}}>Get Started</button>
          <button className="paddingButton" style={{backgroundColor:"#020202", borderRadius:"29.5px",color:"#FFD800",border:"1.5px solid #FFD800"}}>Learn More</button>
        </div>
      </div>
      <div className=""></div>
    </div>
