    ...
    <div className="txt-ff">
      ...
      <div className="mt-5">
        <div className="bg-30 services">
          ...
          <div>
            <div className="txt-ff fs-19 fw-400 d-flex align-items-center justify-content-start flex-wrap gap-3" style={{maxWidth:"511px"}}>
              <div style={{padding:"18px 22px", borderRadius:"30px", backgroundColor:"#222222", maxWidth:"182px"}}>React.JS Development</div>
              <div style={{padding:"18px 22px", borderRadius:"30px", backgroundColor:"#222222", maxWidth:"182px"}}>Vue.js Development</div>
              <div style={{padding:"18px 22px", borderRadius:"30px", backgroundColor:"#222222", maxWidth:"182px"}}>Node.js Development</div>
              <div style={{padding:"18px 22px", borderRadius:"30px", backgroundColor:"#222222", maxWidth:"182px"}}>Laravel Development</div>
            </div>
