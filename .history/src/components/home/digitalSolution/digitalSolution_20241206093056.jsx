      ...
      <div className="mt-5">
        <div className="bg-30 services">
          ...
          <div>
            ...
            <div className="fs-16" style={{maxWidth:"471px", marginTop:"32px", marginBottom:"48"}}>Creating responsive, scalable websites focused on performance and user experience.</div>
