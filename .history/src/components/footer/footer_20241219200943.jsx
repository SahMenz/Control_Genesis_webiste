...
function Footer() {
  return (
    <div className="footerContainer spacing-50">
        ...
        <div className="txt-ff my-5 d-flex justify-content-between align-items-center gap-4 flex-wrap">
            <div className="fs-19">
        ...
        <small className="txt-ff mt-5 d-flex align-items-center flex-wrap justify-content-center">&#169; &nbsp; 2024 Powered By &nbsp; <img src={logoAndName}/> &nbsp; - All right reserved </small>
    </div>
  );
}
