function ServicesHero() {
  return (
    <div style={{ color: "#fff" }} className="d-flex gap-4 flex-wrap align-items-center justify-content-center justify-content-xxl-between">
      <div style={{ margin: "30px 0px 60px 0px", maxWidth:"6798px" }}>
