function ServicesHero() {
  return (
    <div style={{ color: "#fff" }} className="d-flex gap-4 flex-wrap align-items-center justify-content-center justify-content-lg-between">
      ...
      <div className="fs-13 txt-00 fw-500 d-flex flex-wrap gap-3 align-items-center justify-content-center" style={{maxWidth:"500px" }}>
        <div style={{backgroundColor:"#FFD800", padding:"14px 39px", borderRadius:"23px", width:"fit-content"}}>market research & analysis</div>
        <div style={{backgroundColor:"#FFD800", padding:"14px 39px", borderRadius:"23px", width:"fit-content"}}>Mobile app Development</div>
        <div style={{backgroundColor:"#FFD800", padding:"14px 39px", borderRadius:"23px", width:"fit-content"}}>Visual design</div>
        ...
        <div style={{backgroundColor:"#FFD800", padding:"14px 39px", borderRadius:"23px", width:"fit-content"}}>ui/ux design</div>
        <div style={{backgroundColor:"#FFD800", padding:"14px 39px", borderRadius:"23px", width:"fit-content"}}>cx management</div>
        <div style={{backgroundColor:"#FFD800", padding:"14px 39px", borderRadius:"23px", width:"fit-content"}}>Website Development</div>
      </div>
    </div>
  );
}
