  ...
  return (
    <>
      ...
      <div className="txt-ff mt-5">
        ...
        <div className="d-flex mt-4 align-items-center justify-content-center gap-4 mt-4 flex-wrap">
          <div style={{padding:"30px", borderRadius:"8px", maxWidth:"398px", backgroundColor:"#303030"}}>
            <div style={{display:"flex", justifyContent:"space-between", alignItems:"center"}}>
              ...
              <div><CustomSvg name="excellence"/></div>
            </div>
            <div style={{maxHeight:"180px", height:"40vw"}}></div>
            <div className="fs-19 fw-400 mb-3">Delivering quality and precision in every endeavor, ensuring that every detail meets the highest standards of excellence.</div>
          ...
          <div style={{padding:"30px", borderRadius:"8px", maxWidth:"398px", backgroundColor:"#303030"}}>
            <div style={{display:"flex", justifyContent:"space-between", alignItems:"center"}}>
              ...
              <div><CustomSvg name="client"/></div>
            </div>
            <div style={{maxHeight:"180px", height:"40vw"}}></div>
            <div className="fs-19 fw-400 mb-3">Focusing on client needs to provide customized solutions that ensure optimal results, drive efficiency, and create lasting impact.</div>
            <div style={{width:"140px", height:"1px", backgroundColor:"#fff"}}></div>
          </div>
          ...
          <div style={{padding:"30px", borderRadius:"8px", maxWidth:"398px", backgroundColor:"#303030"}}>
            <div style={{display:"flex", justifyContent:"space-between", alignItems:"center"}}>
              ...
              <div><CustomSvg name="sustainable"/></div>
            </div>
            <div style={{maxHeight:"212px", height:"40vw"}}></div>
            <div className="fs-19 fw-400 mb-3">Creating long-term value through responsible practices that foster growth, sustainability, and positive impact.</div>
            <div style={{width:"140px", height:"1px", backgroundColor:"#fff"}}></div>
          </div>
        </div>
      </div>
