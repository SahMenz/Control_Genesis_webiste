      ...
      <div>
        ...
        <div className="txt-ff mb-5 gap-3 d-flex justify-content-center align-items-center justify-content-lg-between flex-wrap">
            <div>
                ...
                <div style={{borderRadius:"30px", backgroundColor:"#222222", maxWidth:"374px", maxHeight:"80px", height:"30vw", margin:"80px 0px"}}></div>
                <div>
            ...
            <div>
                <div style={{borderRadius:"30px", backgroundColor:"#222222", maxWidth:"374px", maxHeight:"80px", height:"30vw", marginBottom:"80px"}}></div>
                <div>
                ...
                <div style={{borderRadius:"30px", backgroundColor:"#222222", maxWidth:"374px", maxHeight:"80px", height:"30vw", marginTop:"80px"}}></div>
            </div>
            
            
            <div>
                <div style={{borderRadius:"30px", backgroundColor:"transparent", maxWidth:"374px", maxHeight:"80px", height:"30vw", marginTop:"80px"}}></div>
                <div>
